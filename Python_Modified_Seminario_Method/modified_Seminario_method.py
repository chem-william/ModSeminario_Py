...
def modified_Seminario_method(
    inputfilefolder, outputfilefolder, vibrational_scaling
):
    """
    Program to implement the Modified Seminario Method
    Written by Alice E. A. Allen, TCM, University of Cambridge
    Reference using AEA Allen, MC Payne, DJ Cole,
